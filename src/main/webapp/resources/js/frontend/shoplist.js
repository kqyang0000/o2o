    ...
    function getSearchDivData() {
        ...
        $.getJSON(url, function (data) {
            if (data.success) {
                ...
                var html = "<a href='#' class='button' data-category-id=''>全部</a>";
                // 遍历店铺类别列表，拼接出a标签集
                ...
                var araeList = data.areaList;
                araeList.map(function (item, index) {
        ...
        $.getJSON(url, function (data) {
            if (data.success) {
                ...
                data.shopList.map(function (item, index) {
                    html += "<div class='card' data-shop-id='" + item.shopId + "'><div class='card-header'>" + item.shopName + "</div>"
                        + "<div class='card-content'><div class='list-block media-list'><ul><li class='item-content'><div class='item-media'>"
                        + "<img src='" + item.shopImg + "' width='44'/></div><div class='item-inner'><div class='item-subtitle'>"

...
public class JedisUtil {
    ...
    public class Keys {
         ...
         * @return 状态码
         */
        public long renamex(String oldkey, String newkey) {
            Jedis jedis = getJedis();
        ...
        /**
         * 设置key的过期时间，距1970年1月1日 00:00:00 的偏移量
         *
         * @param key
         * @param timestamp
         * @return 影响的记录数
         */
        public long exprieAt(String key, long timestamp) {
            Jedis jedis = getJedis();
    ...
    public class Strings {
         ...
         * @param key
         * @param value
         * @return 1-插入成功且key不存在 0-未插入key存在
         */
        public long setNx(String key, String value) {
            Jedis jedis = getJedis();
            Long lon = jedis.setnx(key, value);
            jedis.close();
            return lon;
        }
        ...
        /**
         * 从指定位置开始插入数据，插入数据会覆盖指定位置以后的数据<br/>
         * 例:String str = "123456789"; <br/>
         * 对str操作后setRange(key,0000,4) str = "123400009";
         *
         * @param key
         * @param value
         * @param offset
        ...
        /**
         * 将key对应的value减去指定的值，只有value可以转换为数字时改方法才可用
         *
         * @param key
         * @param num
         * @return 减去指定值后的值
         ...
         *
         * @param key
         * @param startoffset 包括开始位置
         * @param endOffset   包括结束位置
         * @return 截取的值
         */
        ...
        /**
         * 批量获取记录，如果指定的key不存在，返回List的对应位置将是null
         *
         * @param keys
         * @return List 值的集合
         */
